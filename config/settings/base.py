...
MIGRATION_MODULES = {"sites": "hr_payroll.contrib.sites.migrations"}
...
# Make duplicate emails raise a validation error at signup instead of
...
ACCOUNT_FORMS = {"signup": "hr_payroll.users.forms.UserSignupForm"}
# https://docs.allauth.org/en/latest/socialaccount/configuration.html
SOCIALACCOUNT_ADAPTER = "hr_payroll.users.adapters.SocialAccountAdapter"
# https://docs.allauth.org/en/latest/socialaccount/configuration.html
SOCIALACCOUNT_FORMS = {"signup": "hr_payroll.users.forms.UserSocialSignupForm"}
