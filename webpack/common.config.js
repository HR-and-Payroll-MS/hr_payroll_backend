...
module.exports = {
  ...
  entry: {
    ...
    admin_theme: path.resolve(__dirname, '../hr_payroll/static/js/admin_theme'),
    admin_dashboard: path.resolve(__dirname, '../hr_payroll/static/js/admin_dashboard'),
  },
  output: {
    path: path.resolve(
      __dirname,
      '../hr_payroll/static/webpack_bundles/',
    ),
